...
namespace ustdex {
  ...
  struct _thread_id {
    ...
    USTDEX_HOST_DEVICE friend bool
      operator==(const _thread_id& self, const _thread_id& other) noexcept {
      USTDEX_FOR_HOST_OR_DEVICE(
        (return self._host == other._host;), (return self._device == other._device;))
    }
