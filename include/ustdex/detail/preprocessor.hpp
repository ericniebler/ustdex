...
#define USTDEX_PP_DEFER(M)       M USTDEX_PP_EMPTY()

#define USTDEX_PP_CHECK(...)          USTDEX_PP_EXPAND(USTDEX_PP_DEFER(USTDEX_PP_CHECK_)(__VA_ARGS__, 0, ))
#define USTDEX_PP_CHECK_(XP, NP, ...) NP
#define USTDEX_PP_PROBE(XP, NP)       USTDEX_PP_PROBE_(XP, NP, 1)
